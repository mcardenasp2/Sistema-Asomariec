        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    // var buttons = '<a href="#" onclick=Delete("' + row.id + '") class="btn btn-danger btn-sm btn-flat"><i class="fas fa-trash-alt"></i></a> ';
                    var buttons = '<a href="#" onclick=Deletes("' + row.id + '","/compra/compra/eliminar/") class="btn btn-danger btn-sm btn-flat"><i class="fas fa-trash-alt"></i></a> ';
