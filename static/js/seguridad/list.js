        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a title="Editar" href="/seguridad/modulo/editar/' + row.id + '/" class="btn btn-warning btn-sm btn-flat"><i class="fas fa-edit"></i></a> ';
                    // buttons += '<a onclick=Delete(row.id)  title="Eliminar" href="#" type="button" class="btn btn-danger btn-sm btn-flat"><i class="fas fa-trash-alt"></i></a>';
