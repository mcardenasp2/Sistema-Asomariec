    ...
    tbl=$('#data').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var html = '';
                    $.each(row.grupos, function (key, value) {
                        html += '<span class="badge badge-success">' + value.nombre + '</span> ';
                    });
                    return html;
                }
            },
            {
                ...
                orderable: false,
                render: function (data, type, row) {
                    var buttons = '<a title="Editar" href="/seguridad/grupomodulo/editar/' + row.id + '/" class="btn btn-warning btn-sm btn-flat"><i class="fas fa-edit"></i></a> ';
