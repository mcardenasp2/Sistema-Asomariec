        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="#" onclick=Deletes("' + row.id + '","/cliente/cliente/eliminar/")  title="Eliminar"  type="button" class="btn btn-danger btn-sm btn-flat"><i class="fas fa-trash-alt"></i></a>';
...
// Delete(id,'/cliente/cliente/eliminar/');
